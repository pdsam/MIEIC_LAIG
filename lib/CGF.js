    ...
    if (typeof exports === "undefined") {
        ...
        h.determinant = function (t) {
            var e = t[0],
                ...
                c = t[7],
                u = t[8];
            return e * (u * s - o * c) + i * (-u * n + o * a) + r * (c * n - s * a)
        };
        ...
        f.adjoint = function (t, e) {
            var i = e[0],
                ...
                m = e[14],
                _ = e[15];
            t[0] = a * (d * _ - f * m) - h * (c * _ - u * m) + v * (c * f - u * d);
            t[1] = -(r * (d * _ - f * m) - h * (n * _ - s * m) + v * (n * f - s * d));
            t[2] = r * (c * _ - u * m) - a * (n * _ - s * m) + v * (n * u - s * c);
            t[3] = -(r * (c * f - u * d) - a * (n * f - s * d) + h * (n * u - s * c));
            t[4] = -(o * (d * _ - f * m) - l * (c * _ - u * m) + p * (c * f - u * d));
            t[5] = i * (d * _ - f * m) - l * (n * _ - s * m) + p * (n * f - s * d);
            t[6] = -(i * (c * _ - u * m) - o * (n * _ - s * m) + p * (n * u - s * c));
            t[7] = i * (c * f - u * d) - o * (n * f - s * d) + l * (n * u - s * c);
            t[8] = o * (h * _ - f * v) - l * (a * _ - u * v) + p * (a * f - u * h);
            t[9] = -(i * (h * _ - f * v) - l * (r * _ - s * v) + p * (r * f - s * h));
            t[10] = i * (a * _ - u * v) - o * (r * _ - s * v) + p * (r * u - s * a);
            t[11] = -(i * (a * f - u * h) - o * (r * f - s * h) + l * (r * u - s * a));
            t[12] = -(o * (h * m - d * v) - l * (a * m - c * v) + p * (a * d - c * h));
            t[13] = i * (h * m - d * v) - l * (r * m - n * v) + p * (r * d - n * h);
            t[14] = -(i * (a * m - c * v) - o * (r * m - n * v) + p * (r * c - n * a));
            t[15] = i * (a * d - c * h) - o * (r * d - n * h) + l * (r * c - n * a);
            return t
        };
        f.determinant = function (t) {
            var e = t[0],
                ...
                M = l * m - d * p,
                S = h * m - d * v;
            return _ * S - g * M + b * T + x * C - y * A + E * w
        };
        ...
        f.translate = function (t, e, i) {
            ...
            if (e === t) {
                ...
                t[10] = m;
                t[11] = _;
                t[12] = o * r + l * n + p * s + e[12];
                t[13] = a * r + h * n + v * s + e[13];
                t[14] = c * r + d * n + m * s + e[14];
                t[15] = u * r + f * n + _ * s + e[15]
            }
            return t
        };
        ...
        f.rotate = function (t, i, r, n) {
            var s = n[0],
                ...
                u, l, h, d, f, p, v, m, _, g, b, x, y, E, w, A, C, T, M, S, R, F, k, B;
            if (Math.abs(c) < e) {
                return null
            }
            c = 1 / c;
...
! function (t, e) {
    ...
    function e(t, e) {
        ...
        return "CSS_RGB" === i ? "rgb(" + r + "," + n + "," + s + ")" : "CSS_RGBA" === i ? "rgba(" + r + "," + n + "," + s + "," + o + ")" : "HEX" === i ? "0x" + t.hex.toString(16) : "RGB_ARRAY" === i ? "[" + r + "," + n + "," + s + "]" : "RGBA_ARRAY" === i ? "[" + r + "," + n + "," + s + "," + o + "]" : "RGB_OBJ" === i ? "{r:" + r + ",g:" + n + ",b:" + s + "}" : "RGBA_OBJ" === i ? "{r:" + r + ",g:" + n + ",b:" + s + ",a:" + o + "}" : "HSV_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + u + "}" : "HSVA_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + u + ",a:" + o + "}" : "unknown format"
    }
    ...
    function f(t, e, i) {
        if (i.__li = e, i.__gui = t, M.extend(i, {
            ...
            }), H.addClass(e, "has-slider"), i.domElement.insertBefore(r.domElement, i.domElement.firstElementChild)
        ...
        })) : i instanceof $ && (H.addClass(e, "color"), i.updateDisplay = M.compose(function (t) {
    ...
    function v(t, e, i, r) {
        ...
        r.before instanceof N && (r.before = r.before.__li), p(t, n), H.addClass(n.domElement, "c");
        var o = document.createElement("span");
        H.addClass(o, "property-name"), o.innerHTML = n.property;
        var a = document.createElement("div");
        a.appendChild(o), a.appendChild(n.domElement);
        var c = l(t, a, r.before);
        return H.addClass(c, ft.CLASS_CONTROLLER_ROW), n instanceof $ ? H.addClass(c, "color") : H.addClass(c, O(n.getValue())), f(t, c, n), t.__controllers.push(n), n
    }
    ...
    function b(t) {
        ...
        r.innerHTML = "Save", H.addClass(r, "button"), H.addClass(r, "save");
        var n = document.createElement("span");
        n.innerHTML = "New", H.addClass(n, "button"), H.addClass(n, "save-as");
        var s = document.createElement("span");
        s.innerHTML = "Revert", H.addClass(s, "button"), H.addClass(s, "revert");
        var o = t.__preset_select = document.createElement("select");
        if (t.load && t.load.remembered ? M.each(t.load.remembered, function (e, i) {
                _(t, i, i === t.preset)
            }) : _(t, ot, !1), H.bind(o, "change", function () {
    ...
    function x(t) {
        ...
        function i() {
            H.removeClass(t.__closeButton, ft.CLASS_DRAG), H.unbind(window, "mousemove", e), H.unbind(window, "mouseup", i)
        }

        function r(r) {
            return r.preventDefault(), n = r.clientX, H.addClass(t.__closeButton, ft.CLASS_DRAG), H.bind(window, "mousemove", e), H.bind(window, "mouseup", i), !1
        }
        var n = void 0;
        t.__resize_handle = document.createElement("div"), M.extend(t.__resize_handle.style, {
            ...
            cursor: "ew-resize",
            position: "absolute"
        }), H.bind(t.__resize_handle, "mousedown", r), H.bind(t.__closeButton, "mousedown", r), t.domElement.insertBefore(t.__resize_handle, t.domElement.firstElementChild)
    }
    ...
    var C = Array.prototype.forEach,
        ...
        M = {
            BREAK: {},
            extend: function (t) {
                return this.each(T.call(arguments, 1), function (e) {
            ...
            compose: function () {
                var t = T.call(arguments);
                return function () {
                    for (var e = T.call(arguments), i = t.length - 1; i >= 0; i--) e = [t[i].apply(this, e)];
                    return e[0]
                }
            },
            each: function (t, e, i) {
            ...
            toArray: function (t) {
                return t.toArray ? t.toArray() : T.call(t)
            },
        ...
        I = function () {
            function t() {
                if (D(this, t), this.__state = k.apply(this, arguments), !1 === this.__state) throw new Error("Failed to interpret color arguments");
    ...
    var j = /(\d+(\.\d+)?)px/,
        H = {
                ...
                switch (s) {
                    ...
                    case "KeyboardEvents":
                        ...
                        M.defaults(n, {
                            ...
                            keyCode: void 0,
                            charCode: void 0
                        }), u(e, n.bubbles || !1, n.cancelable, window, n.ctrlKey, n.altKey, n.shiftKey, n.metaKey, n.keyCode, n.charCode);
                        break;
                    default:
            ...
            bind: function (t, e, i, r) {
                var n = r || !1;
                return t.addEventListener ? t.addEventListener(e, i, n) : t.attachEvent && t.attachEvent("on" + e, i), H
            },
            unbind: function (t, e, i, r) {
                var n = r || !1;
                return t.removeEventListener ? t.removeEventListener(e, i, n) : t.detachEvent && t.detachEvent("on" + e, i), H
            },
        ...
        Y = function (t) {
            function e(t, i) {
                D(this, e);
                var r = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    n = r;
                return r.__prev = r.getValue(), r.__checkbox = document.createElement("input"), r.__checkbox.setAttribute("type", "checkbox"), H.bind(r.__checkbox, "change", function () {
                    n.setValue(!n.__prev)
        ...
        q = function (t) {
            function e(t, i, r) {
                D(this, e);
                var n = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = r,
                    o = n;
                ...
                }), n.updateDisplay(), H.bind(n.__select, "change", function () {
            ...
            return G(e, N), P(e, [{
                ...
                key: "updateDisplay",
                value: function () {
                    return H.isActive(this.__select) ? this : (this.__select.value = this.getValue(), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this))
                }
            }]), e
        }(),
        W = function (t) {
            function e(t, i) {
                ...
                var n = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = n;
                return n.__input = document.createElement("input"), n.__input.setAttribute("type", "text"), H.bind(n.__input, "keyup", r), H.bind(n.__input, "change", r), H.bind(n.__input, "blur", function () {
                    s.__onFinishChange && s.__onFinishChange.call(s, s.getValue())
                }), H.bind(n.__input, "keydown", function (t) {
            ...
            return G(e, N), P(e, [{
                key: "updateDisplay",
                value: function () {
                    return H.isActive(this.__input) || (this.__input.value = this.getValue()), U(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        K = function (t) {
        ...
        Q = function (t) {
            function e(t, i, r) {
                ...
                function o() {
                    H.unbind(window, "mousemove", s), H.unbind(window, "mouseup", o), n()
                }
                D(this, e);
                var a = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, r));
                ...
                return a.__input = document.createElement("input"), a.__input.setAttribute("type", "text"), H.bind(a.__input, "change", function () {
                    ...
                    H.bind(window, "mousemove", s), H.bind(window, "mouseup", o), u = t.clientY
        ...
        J = function (t) {
            function e(t, i, r, n, s) {
                ...
                function c() {
                    H.unbind(window, "mousemove", o), H.unbind(window, "mouseup", c), d.__onFinishChange && d.__onFinishChange.call(d, d.getValue())
                }
                ...
                function l() {
                    H.unbind(window, "touchmove", u), H.unbind(window, "touchend", l), d.__onFinishChange && d.__onFinishChange.call(d, d.getValue())
                }
                D(this, e);
                var h = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, {
                        min: r,
                        max: n,
                        step: s
                    })),
                ...
                return h.__background = document.createElement("div"), h.__foreground = document.createElement("div"), H.bind(h.__background, "mousedown", function (t) {
                    document.activeElement.blur(), H.bind(window, "mousemove", o), H.bind(window, "mouseup", c), o(t)
        ...
        Z = function (t) {
            function e(t, i, r) {
                ...
                var n = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = n;
                return n.__button = document.createElement("div"), n.__button.innerHTML = void 0 === r ? "Fire" : r, H.bind(n.__button, "click", function (t) {
                    return t.preventDefault(), s.fire(), !1
                }), H.addClass(n.__button, "button"), n.domElement.appendChild(n.__button), n
            }
            return G(e, N), P(e, [{
                key: "fire",
                value: function () {
        ...
        $ = function (t) {
            function e(t, i) {
                function r(t) {
                    h(t), H.bind(window, "mousemove", h), H.bind(window, "touchmove", h), H.bind(window, "mouseup", s), H.bind(window, "touchend", s)
                }

                function n(t) {
                    d(t), H.bind(window, "mousemove", d), H.bind(window, "touchmove", d), H.bind(window, "mouseup", o), H.bind(window, "touchend", o)
                }

                function s() {
                    H.unbind(window, "mousemove", h), H.unbind(window, "touchmove", h), H.unbind(window, "mouseup", s), H.unbind(window, "touchend", s), l()
                }

                function o() {
                    H.unbind(window, "mousemove", d), H.unbind(window, "touchmove", d), H.unbind(window, "mouseup", o), H.unbind(window, "touchend", o), l()
                }
                ...
                D(this, e);
                var f = V(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i));
                f.__color = new I(f.getValue()), f.__temp = new I(0);
                var p = f;
                f.domElement = document.createElement("div"), H.makeSelectable(f.domElement, !1), f.__selector = document.createElement("div"), f.__selector.className = "selector", f.__saturation_field = document.createElement("div"), f.__saturation_field.className = "saturation-field", f.__field_knob = document.createElement("div"), f.__field_knob.className = "field-knob", f.__field_knob_border = "2px solid ", f.__hue_knob = document.createElement("div"), f.__hue_knob.className = "hue-knob", f.__hue_field = document.createElement("div"), f.__hue_field.className = "hue-field", f.__input = document.createElement("input"), f.__input.type = "text", f.__input_textShadow = "0 1px 1px ", H.bind(f.__input, "keydown", function (t) {
                    13 === t.keyCode && a.call(this)
                }), H.bind(f.__input, "blur", a), H.bind(f.__selector, "mousedown", function () {
                    H.addClass(this, "drag").bind(window, "mouseup", function () {
                        H.removeClass(p.__selector, "drag")
                    })
                }), H.bind(f.__selector, "touchstart", function () {
                ...
                return M.extend(f.__selector.style, {
                    ...
                    top: "3px",
                    right: "3px"
                }), u(f.__hue_field), M.extend(f.__input.style, {
                    outline: "none",
                    textAlign: "center",
                    color: "#fff",
                    border: 0,
        ...
        nt = function () {
            function t() {
                D(this, t), this.backgroundElement = document.createElement("div"), M.extend(this.backgroundElement.style, {
                ...
                }), H.makeFullscreen(this.backgroundElement), this.backgroundElement.style.position = "fixed", this.domElement = document.createElement("div"), M.extend(this.domElement.style, {
                    position: "fixed",
                    display: "none",
                    zIndex: "1001",
                    opacity: 0,
    ...
    var ot = "Default",
        ...
        ft = function t(e) {
            var i = this,
                r = e || {};
            this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), H.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], r = M.defaults(r, {
                closeOnTop: !1,
                autoPlace: !0,
            ...
            if (Object.defineProperties(this, {
                    ...
                    closed: {
                        ...
                        set: function (e) {
                            r.closed = e, r.closed ? H.addClass(i.__ul, t.CLASS_CLOSED) : H.removeClass(i.__ul, t.CLASS_CLOSED), this.onResize(), i.__closeButton && (i.__closeButton.innerHTML = e ? t.TEXT_OPEN : t.TEXT_CLOSED)
                        }
                    },
                    load: {
                        get: function () {
                    ...
                    useLocalStorage: {
                        ...
                        set: function (t) {
                            at && (n = t, t ? H.bind(window, "unload", s) : H.unbind(window, "unload", s), localStorage.setItem(m(i, "isLocal"), t))
                        }
                    }
                }), M.isUndefined(r.parent)) {
                if (this.closed = r.closed || !1, H.addClass(this.domElement, t.CLASS_MAIN), H.makeSelectable(this.domElement, !1), at && n) {
                    i.useLocalStorage = !0;
                    var a = localStorage.getItem(m(this, "gui"));
                    a && (r.load = JSON.parse(a))
                }
                this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = t.TEXT_CLOSED, H.addClass(this.__closeButton, t.CLASS_CLOSE_BUTTON), r.closeOnTop ? (H.addClass(this.__closeButton, t.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (H.addClass(this.__closeButton, t.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)), H.bind(this.__closeButton, "click", function () {
                    i.closed = !i.closed
                })
            } else {
                void 0 === r.closed && (r.closed = !0);
                var c = document.createTextNode(r.name);
                H.addClass(c, "controller-name"), o = l(i, c);
                H.addClass(this.__ul, t.CLASS_CLOSED), H.addClass(o, "title"), H.bind(o, "click", function (t) {
                    return t.preventDefault(), i.closed = !i.closed, !1
                }), r.closed || (this.closed = !1)
            }
            r.autoPlace && (M.isUndefined(r.parent) && (ut && (lt = document.createElement("div"), H.addClass(lt, "dg"), H.addClass(lt, t.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(lt), ut = !1), lt.appendChild(this.domElement), H.addClass(this.domElement, t.CLASS_AUTO_PLACE)), this.parent || y(i, r.width)), this.__resizeHandler = function () {
                i.onResizeDebounced()
            }, H.bind(window, "resize", this.__resizeHandler), H.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler), H.bind(this.__ul, "transitionend", this.__resizeHandler), H.bind(this.__ul, "oTransitionEnd", this.__resizeHandler), this.onResize(), r.resizable && x(this), s = function () {
    ...
    ft.toggleHide = function () {
    ...
    }, H.bind(window, "keydown", ft._keydownHandler, !1), M.extend(ft.prototype, {
        add: function (t, e) {
            return v(this, t, e, {
        ...
        destroy: function () {
            ...
            M.each(this.__folders, function (e) {
                t.removeFolder(e)
            }), H.unbind(window, "keydown", ft._keydownHandler, !1), h(this)
        },
        addFolder: function (t) {
            ...
            var i = new ft(e);
            this.__folders[t] = i;
            var r = l(this, i.domElement);
            return H.addClass(r, "folder"), i
        },
        ...
        onResize: function () {
            ...
            if (t.scrollable) {
                ...
                }), window.innerHeight - e - 20 < i ? (H.addClass(t.domElement, ft.CLASS_TOO_TALL), t.__ul.style.height = window.innerHeight - e - 20 + "px") : (H.removeClass(t.domElement, ft.CLASS_TOO_TALL), t.__ul.style.height = "auto")
            }
...
class CGFshader {
    ...
    compile_program(t, e) {
        ...
        for (var s = 0; s < c; ++s) {
            var u = i.getActiveAttrib(r, s);
            var a = i.getAttribLocation(r, u.name);
...
CGFnurbsUtils = {
    ...
    calcSurfacePoint: function (t, e, i, r, n, s, o) {
        ...
        var l = this.calcBasisFunctions(c, o, e, r);
        var h = [];
        for (var d = 0; d <= e; ++d) {
...
CGFnurbsObject = function (t, e, i, r) {
...
CGFnurbsObject.prototype.computeFaceNormal = function (t, e, i, r) {
    var n = t * 3;
    var s = e * 3;
    var o = i * 3;
