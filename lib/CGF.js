...
if (typeof module === "object") {
    ...
    if (typeof exports === "undefined") {
        ...
        f.adjoint = function (t, e) {
            ...
            t[1] = -(n * (d * _ - f * m) - h * (r * _ - s * m) + v * (r * f - s * d));
            t[2] = n * (c * _ - u * m) - a * (r * _ - s * m) + v * (r * u - s * c);
            t[3] = -(n * (c * f - u * d) - a * (r * f - s * d) + h * (r * u - s * c));
            t[4] = -(o * (d * _ - f * m) - l * (c * _ - u * m) + p * (c * f - u * d));
            t[5] = i * (d * _ - f * m) - l * (r * _ - s * m) + p * (r * f - s * d);
            t[6] = -(i * (c * _ - u * m) - o * (r * _ - s * m) + p * (r * u - s * c));
            t[7] = i * (c * f - u * d) - o * (r * f - s * d) + l * (r * u - s * c);
            t[8] = o * (h * _ - f * v) - l * (a * _ - u * v) + p * (a * f - u * h);
            t[9] = -(i * (h * _ - f * v) - l * (n * _ - s * v) + p * (n * f - s * h));
            t[10] = i * (a * _ - u * v) - o * (n * _ - s * v) + p * (n * u - s * a);
            t[11] = -(i * (a * f - u * h) - o * (n * f - s * h) + l * (n * u - s * a));
            t[12] = -(o * (h * m - d * v) - l * (a * m - c * v) + p * (a * d - c * h));
            t[13] = i * (h * m - d * v) - l * (n * m - r * v) + p * (n * d - r * h);
            t[14] = -(i * (a * m - c * v) - o * (n * m - r * v) + p * (n * c - r * a));
        ...
        f.determinant = function (t) {
            var e = t[0],
                ...
                S = l * m - d * p,
                T = h * m - d * v;
            return _ * T - g * S + b * M + x * C - y * A + w * E
        };
        f.multiply = function (t, e, i) {
            ...
            t[8] = b * n + x * a + y * h + w * v;
            t[9] = b * r + x * c + y * d + w * m;
            t[10] = b * s + x * u + y * f + w * _;
            t[11] = b * o + x * l + y * p + w * g;
            b = i[12];
            x = i[13];
            y = i[14];
            w = i[15];
            t[12] = b * n + x * a + y * h + w * v;
            t[13] = b * r + x * c + y * d + w * m;
            t[14] = b * s + x * u + y * f + w * _;
            t[15] = b * o + x * l + y * p + w * g;
            return t
        };
        f.mul = f.multiply;
        f.translate = function (t, e, i) {
            ...
            if (e === t) {
                ...
                t[13] = a * n + h * r + v * s + e[13];
                t[14] = c * n + d * r + m * s + e[14];
        ...
        f.rotate = function (t, i, n, r) {
            var s = r[0],
                ...
                u, l, h, d, f, p, v, m, _, g, b, x, y, w, E, A, C, M, S, T, R, k, F, L;
            if (Math.abs(c) < e) {
                return null
            }
            c = 1 / c;
...
! function (t, e) {
    ...
    function e(t, e) {
        ...
        return "CSS_RGB" === i ? "rgb(" + n + "," + r + "," + s + ")" : "CSS_RGBA" === i ? "rgba(" + n + "," + r + "," + s + "," + o + ")" : "HEX" === i ? "0x" + t.hex.toString(16) : "RGB_ARRAY" === i ? "[" + n + "," + r + "," + s + "]" : "RGBA_ARRAY" === i ? "[" + n + "," + r + "," + s + "," + o + "]" : "RGB_OBJ" === i ? "{r:" + n + ",g:" + r + ",b:" + s + "}" : "RGBA_OBJ" === i ? "{r:" + n + ",g:" + r + ",b:" + s + ",a:" + o + "}" : "HSV_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + u + "}" : "HSVA_OBJ" === i ? "{h:" + a + ",s:" + c + ",v:" + u + ",a:" + o + "}" : "unknown format"
    }
    ...
    function v(t, e, i, n) {
        ...
        H.addClass(o, "property-name"), o.innerHTML = r.property;
        var a = document.createElement("div");
        a.appendChild(o), a.appendChild(r.domElement);
        var c = l(t, a, n.before);
        return H.addClass(c, ft.CLASS_CONTROLLER_ROW), r instanceof $ ? H.addClass(c, "color") : H.addClass(c, O(r.getValue())), f(t, c, r), t.__controllers.push(r), r
    }
    ...
    function b(t) {
        ...
        if (t.load && t.load.remembered ? S.each(t.load.remembered, function (e, i) {
                ...
                t.preset = this.value
            }), e.appendChild(o), e.appendChild(i), e.appendChild(n), e.appendChild(r), e.appendChild(s), at) {
    ...
    function x(t) {
        ...
        function n(n) {
            return n.preventDefault(), r = n.clientX, H.addClass(t.__closeButton, ft.CLASS_DRAG), H.bind(window, "mousemove", e), H.bind(window, "mouseup", i), !1
        }
        var r = void 0;
    ...
    var C = Array.prototype.forEach,
        ...
        B = {
            ...
            rgb_to_hsv: function (t, e, i) {
                ...
                return 0 === r ? {
                    ...
                    s: 0,
                    v: 0
                } : (a = s / r, o = t === r ? (e - i) / s : e === r ? 2 + (i - t) / s : 4 + (t - e) / s, (o /= 6) < 0 && (o += 1), {
                    h: 360 * o,
                    s: a,
                    v: r / 255
                })
        ...
        I = function () {
            function t() {
                if (P(this, t), this.__state = F.apply(this, arguments), !1 === this.__state) throw new Error("Failed to interpret color arguments");
    ...
    }, I.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"], i(I.prototype, "r", 2), i(I.prototype, "g", 1), i(I.prototype, "b", 0), n(I.prototype, "h"), n(I.prototype, "s"), n(I.prototype, "v"), Object.defineProperty(I.prototype, "a", {
        get: function () {
    ...
    var N = function () {
            function t(e, i) {
                P(this, t), this.initialValue = e[i], this.domElement = document.createElement("div"), this.object = e, this.property = i, this.__onChange = void 0, this.__onFinishChange = void 0
            }
            return D(t, [{
                key: "onChange",
                value: function (t) {
    ...
    var X = /(\d+(\.\d+)?)px/,
        H = {
            ...
            fakeEvent: function (t, e, i, n) {
                ...
                switch (s) {
                    case "MouseEvents":
                        var a = r.x || r.clientX || 0,
                            c = r.y || r.clientY || 0;
                        o.initMouseEvent(e, r.bubbles || !1, r.cancelable || !0, window, r.clickCount || 1, 0, 0, a, c, !1, !1, !1, !1, 0, null);
                        break;
                    case "KeyboardEvents":
                ...
                S.defaults(o, n), t.dispatchEvent(o)
            },
        ...
        Y = function (t) {
            function e(t, i) {
                P(this, e);
                var n = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    r = n;
            ...
            return G(e, N), D(e, [{
                key: "setValue",
                value: function (t) {
                    var i = V(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setValue", this).call(this, t);
        ...
        q = function (t) {
            function e(t, i, n) {
                P(this, e);
                var r = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    s = n,
                    o = r;
                if (r.__select = document.createElement("select"), S.isArray(s)) {
                    var a = {};
                    S.each(s, function (t) {
                        a[t] = t
                    }), s = a
            ...
            return G(e, N), D(e, [{
                ...
                key: "updateDisplay",
                value: function () {
                    return H.isActive(this.__select) ? this : (this.__select.value = this.getValue(), V(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this))
                }
            }]), e
        }(),
        W = function (t) {
            ...
            return G(e, N), D(e, [{
                key: "updateDisplay",
                value: function () {
                    return H.isActive(this.__input) || (this.__input.value = this.getValue()), V(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        K = function (t) {
            function e(t, i, n) {
                ...
                var r = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i)),
                    o = n || {};
                return r.__min = o.min, r.__max = o.max, r.__step = o.step, S.isUndefined(r.__step) ? 0 === r.initialValue ? r.__impliedStep = 1 : r.__impliedStep = Math.pow(10, Math.floor(Math.log(Math.abs(r.initialValue)) / Math.LN10)) / 10 : r.__impliedStep = r.__step, r.__precision = s(r.__impliedStep), r
            }
            return G(e, N), D(e, [{
                key: "setValue",
                value: function (t) {
                    var i = t;
                    return void 0 !== this.__min && i < this.__min ? i = this.__min : void 0 !== this.__max && i > this.__max && (i = this.__max), void 0 !== this.__step && i % this.__step != 0 && (i = Math.round(i / this.__step) * this.__step), V(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "setValue", this).call(this, i)
                }
            }, {
                key: "min",
                value: function (t) {
        ...
        Q = function (t) {
            function e(t, i, n) {
                ...
                function o() {
                    H.unbind(window, "mousemove", s), H.unbind(window, "mouseup", o), r()
                }
                P(this, e);
                var a = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, n));
            ...
            return G(e, K), D(e, [{
                key: "updateDisplay",
                value: function () {
                    return this.__input.value = this.__truncationSuspended ? this.getValue() : o(this.getValue(), this.__precision), V(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "updateDisplay", this).call(this)
                }
            }]), e
        }(),
        J = function (t) {
            function e(t, i, n, r, s) {
                ...
                P(this, e);
                var h = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i, {
                        min: n,
                        max: r,
                        step: s
                    })),
        ...
        $ = function (t) {
            function e(t, i) {
                ...
                P(this, e);
                var f = U(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i));
                ...
                return S.extend(f.__selector.style, {
                    width: "122px",
                    height: "102px",
                    padding: "3px",
                    backgroundColor: "#222",
                    boxShadow: "0px 1px 3px rgba(0,0,0,0.3)"
                }), S.extend(f.__field_knob.style, {
                    position: "absolute",
                    width: "12px",
                    height: "12px",
                    ...
                    borderRadius: "12px",
                    zIndex: 1
                }), S.extend(f.__hue_knob.style, {
                    position: "absolute",
                    width: "15px",
                    height: "2px",
                    borderRight: "4px solid #fff",
                    zIndex: 1
                }), S.extend(f.__saturation_field.style, {
                    width: "100px",
                    height: "100px",
                    ...
                    height: "100%",
                    background: "none"
                }), c(v, "top", "rgba(0,0,0,0)", "#000"), S.extend(f.__hue_field.style, {
                    width: "15px",
                    height: "100px",
                    border: "1px solid #555",
                    cursor: "ns-resize",
                    ...
                    top: "3px",
                    right: "3px"
                }), u(f.__hue_field), S.extend(f.__input.style, {
                    outline: "none",
                    textAlign: "center",
                    color: "#fff",
                    border: 0,
                ...
                }), H.bind(f.__saturation_field, "mousedown", n), H.bind(f.__saturation_field, "touchstart", n), H.bind(f.__field_knob, "mousedown", n), H.bind(f.__field_knob, "touchstart", n), H.bind(f.__hue_field, "mousedown", r), H.bind(f.__hue_field, "touchstart", r), f.__saturation_field.appendChild(v), f.__selector.appendChild(f.__field_knob), f.__selector.appendChild(f.__saturation_field), f.__selector.appendChild(f.__hue_field), f.__hue_field.appendChild(f.__hue_knob), f.domElement.appendChild(f.__input), f.domElement.appendChild(f.__selector), f.updateDisplay(), f
            }
            return G(e, N), D(e, [{
                key: "updateDisplay",
                value: function () {
    ...
    var ot = "Default",
        ...
        ft = function t(e) {
            ...
            this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), H.addClass(this.domElement, "dg"), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], n = S.defaults(n, {
                ...
                preset: ot
            } : n.preset && (n.load.preset = n.preset), S.isUndefined(n.parent) && n.hideable && dt.push(this), n.resizable = S.isUndefined(n.parent) && n.resizable, n.autoPlace && S.isUndefined(n.scrollable) && (n.scrollable = !0);
            ...
            if (Object.defineProperties(this, {
                    ...
                    useLocalStorage: {
                        ...
                        set: function (t) {
                            at && (r = t, t ? H.bind(window, "unload", s) : H.unbind(window, "unload", s), localStorage.setItem(m(i, "isLocal"), t))
                        }
                    }
            ...
            n.autoPlace && (S.isUndefined(n.parent) && (ut && (lt = document.createElement("div"), H.addClass(lt, "dg"), H.addClass(lt, t.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(lt), ut = !1), lt.appendChild(this.domElement), H.addClass(this.domElement, t.CLASS_AUTO_PLACE)), this.parent || y(i, n.width)), this.__resizeHandler = function () {
                i.onResizeDebounced()
            }, H.bind(window, "resize", this.__resizeHandler), H.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler), H.bind(this.__ul, "transitionend", this.__resizeHandler), H.bind(this.__ul, "oTransitionEnd", this.__resizeHandler), this.onResize(), n.resizable && x(this), s = function () {
    ...
    ft.toggleHide = function () {
    ...
    }, H.bind(window, "keydown", ft._keydownHandler, !1), S.extend(ft.prototype, {
        add: function (t, e) {
            return v(this, t, e, {
        ...
        save: function () {
            this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = w(this), d(this, !1), this.saveToLocalStorageIfPossible()
        },
        saveAs: function (t) {
            this.load.remembered || (this.load.remembered = {}, this.load.remembered[ot] = w(this, !0)), this.load.remembered[t] = w(this), this.preset = t, _(this, t, !0), this.saveToLocalStorageIfPossible()
        },
        revert: function (t) {
